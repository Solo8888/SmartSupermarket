...
from routes import user_router, category_router, product_router, upload_router, inventory_router, promotion_router, order_router, store_router, user_store_router, cart_router, address_router, review_router, recommendation_router, customer_flow_router, analytics_router, reports_router
